...
namespace Clase02
{
    public partial class AltaPersona : Form
    {
        ...
        private void CargarGrilla()
        {
            ...
            {
                MessageBox.Show("Error al obtener persona: " + ex.Message,"Registrar nueva persona", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void CargarComboTiposDocumentos()
        {
            ...
            {
                MessageBox.Show("Error al obtener tipos de documentos: " + ex.Message, "Registrar nueva persona", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }            
        }
        ...
        {            
            try
            {                
                cmbCarrera.DataSource = AD_Varios.ObtenerObtenerCarreras();
            ...
            {
                MessageBox.Show("Error al obtener carreras: " + ex.Message, "Registrar nueva persona", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }            
        }
